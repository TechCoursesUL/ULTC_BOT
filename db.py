...
class ULTCDB:
    def __init__(self) -> None:
        self.app = firebase_admin.initialize_app(
            credential=firebase_admin.credentials.Certificate("creds.json"),
            options={
                "databaseURL": "https://ultcdb-default-rtdb.europe-west1.firebasedatabase.app/"
            },
        )
    ...
    async def AddBannedUser(
        self,
        userid: str,
        username: str,
        unixendtime: int,
        reason: str,
        staffmember: discord.Member,
    ):
        ref = db.reference("server/users/bannedusers")
